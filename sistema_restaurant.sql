...
CREATE TABLE order_details (
    ...
    status ENUM('PENDIENTE', 'EN PREPARACION', 'SERVIDO', 'COMPLETADO', 'CANCELADO') NOT NULL DEFAULT 'PENDIENTE',
...
ALTER TABLE orders CHANGE order_status order_status ENUM('PENDIENTE', 'EN PROCESO','COMPLETADO') NOT NULL DEFAULT 'PENDIENTE';
ALTER TABLE order_details ADD created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE order_details ADD updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
